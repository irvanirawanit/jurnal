...
<body class="h-full">
    <div class="flex flex-col h-full">
        <div class="bg-indigo-700 sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8 justify-between w-full">
            <div class="logo">
                ...
                <ul role="list" class="flex flex-1 flex-col gap-y-7">
                    <li>
                        <ul role="list" class=" space-y-1 pt-4">
                            <li>
                                <a href="#" class=" px-4 hover:bg-indigo-700 text-white group flex gap-x-3 text-sm leading-6 font-semibold  py-2">
                                    <svg class="h-6 w-6 shrink-0 text-white group-hover:text-white fill-white" xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512">
                            ...
                            <li>
                                <a href="#" class=" px-4 hover:bg-indigo-700 text-white group flex gap-x-3 text-sm leading-6 font-semibold  py-2">
                                    ...
                                    <svg class="h-6 w-6 shrink-0 text-white group-hover:text-white fill-white " xmlns="http://www.w3.org/2000/svg" height="16" width="12" viewBox="0 0 384 512">
                            ...
                            <li>
                                <a href="#" class=" px-4 hover:bg-indigo-700 text-white group flex gap-x-3 text-sm leading-6 font-semibold  py-2">
                                    ...
                                    <svg class="h-6 w-6 shrink-0 text-white group-hover:text-white fill-white " xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512">
                            ...
                            <li>
                                <a href="#" class=" px-4 hover:bg-indigo-700 text-white group flex gap-x-3 text-sm leading-6 font-semibold  py-2">
                                    ...
                                    <svg class="h-6 w-6 shrink-0 text-whitlase group-hover:text-white fill-white " xmlns="http://www.w3.org/2000/svg" height="16" width="18" viewBox="0 0 576 512">
                            ...
                            <li>
                                <a href="#" class=" px-4 hover:bg-indigo-700 text-white group flex gap-x-3 text-sm leading-6 font-semibold  py-2">
                                    ...
                                    <svg class="h-6 w-6 shrink-0 text-white group-hover:text-white fill-white " xmlns="http://www.w3.org/2000/svg" height="16" width="20" viewBox="0 0 640 512">
                            ...
                            <li>
                                <a href="#" class=" px-4 hover:bg-indigo-700 text-white group flex gap-x-3 text-sm leading-6 font-semibold  py-2">
                                    ...
                                    <svg class="h-6 w-6 shrink-0 text-whitlase group-hover:text-white fill-white " xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512">
                            ...
                            <li>
                                <a href="#" class=" px-4 hover:bg-indigo-700 text-white group flex gap-x-3 text-sm leading-6 font-semibold  py-2">
                                    ...
                                    <svg class="h-6 w-6 shrink-0 text-whitlase group-hover:text-white fill-white " xmlns="http://www.w3.org/2000/svg" width="12" height="16" viewBox="0 0 12 16" fill="none">
                                        <path d="M10 14.5C10.275 14.5 10.5 14.275 10.5 14V5H8C7.44687 5 7 4.55313 7 4V1.5H2C1.725 1.5 1.5 1.725 1.5 2V14C1.5 14.275 1.725 14.5 2 14.5H10ZM0 2C0 0.896875 0.896875 0 2 0H7.17188C7.70312 0 8.2125 0.209375 8.5875 0.584375L11.4156 3.4125C11.7906 3.7875 12 4.29688 12 4.82812V14C12 15.1031 11.1031 16 10 16H2C0.896875 16 0 15.1031 0 14V2Z" fill="white" />
                                        <path d="M2 7.58887V7H4.4157V7.58887H3.54906V10H2.86803V7.58887H2Z" fill="white" />
                                        <path d="M5.01439 10H4.27196L5.23628 7H6.15595L7.12028 10H6.37785L5.70658 7.75586H5.68426L5.01439 10ZM4.91531 8.81934H6.46716V9.37012H4.91531V8.81934Z" fill="white" />
                                        <path d="M8.12717 7L8.64911 7.94775H8.67143L9.19895 7H9.97209L9.10964 8.5L10 10H9.20733L8.67143 9.04199H8.64911L8.11321 10H7.32612L8.2123 8.5L7.34845 7H8.12717Z" fill="white" />
                                    </svg>
                                </a>
                            </li>
                            <li>
                                <a href="#" class=" px-4 hover:bg-indigo-700 text-white group flex gap-x-3 text-sm leading-6 font-semibold  py-2">
                                    ...
                                    <svg class="h-6 w-6 shrink-0 text-whitlase group-hover:text-white fill-white " xmlns="http://www.w3.org/2000/svg" width="12" height="16" viewBox="0 0 12 16" fill="none">
                                        <path d="M10 14.5C10.275 14.5 10.5 14.275 10.5 14V5H8C7.44687 5 7 4.55313 7 4V1.5H2C1.725 1.5 1.5 1.725 1.5 2V14C1.5 14.275 1.725 14.5 2 14.5H10ZM0 2C0 0.896875 0.896875 0 2 0H7.17188C7.70312 0 8.2125 0.209375 8.5875 0.584375L11.4156 3.4125C11.7906 3.7875 12 4.29688 12 4.82812V14C12 15.1031 11.1031 16 10 16H2C0.896875 16 0 15.1031 0 14V2Z" fill="white" />
                                        <path d="M6.01528 8.75V5.25938C6.01528 5.11875 6.11862 5 6.25148 5C8.07754 5 9.55818 6.56719 9.55818 8.5C9.55818 8.64062 9.44599 8.75 9.31313 8.75H6.01528ZM2 9.25C2 7.35469 3.33006 5.78594 5.05575 5.53594C5.19156 5.51562 5.3067 5.63125 5.3067 5.77656V9.5L7.61697 11.9453C7.71587 12.05 7.70849 12.2219 7.59482 12.3062C7.01615 12.7437 6.30757 13 5.5429 13C3.58692 13 2 11.3219 2 9.25ZM9.77075 9.5C9.90804 9.5 10.0158 9.62188 9.99809 9.76562C9.88442 10.6391 9.48732 11.4156 8.90717 11.9891C8.8186 12.0766 8.67984 12.0703 8.59422 11.9781L6.25148 9.5H9.77075Z" fill="white" />
                                    </svg>
                                </a>
                            </li>
            ...
            <main class="pt-1 flex-1">
                ...
                <div class="main-tab flex justify-between border-b border-indigo-700 rounded-tl-md rounded-tr-md ">
                    <nav class=" flex space-x-1 " aria-label="Tabs">
                        <a href="#" class="bg-gray-300 text-gray-600 px-3 py-2 rounded-tl-md rounded-tr-md ml-1">Dashboard</a>
                        <a href="#" class="bg-indigo-700 font-semibold text-white px-3 py-2 rounded-tl-md rounded-tr-md "><span>Pembayaran
                ...
                <div class="flex justify-between border-b border-gray-300">
                    <nav class=" flex space-x-1 mt-1 " aria-label="Tabs">
                        <a href="#" class="bg-green-500 text-white px-3 py-1 rounded-tl-md rounded-tr-md ml-1"><i class="fa-solid fa-list"></i></a>
                        <a href="#" class="bg-gray-300 text-gray-600 px-3 py-1 rounded-tl-md rounded-tr-md border-t-2 border-indigo-700 "><span>Data
                                Baru </span><i class="fa-solid fa-x ml-3 text-xs font-bold"></i></a>
                    </nav>
                    <nav class=" flex space-x-1 mt-1 mr-1 mb-1" aria-label="Tabs">
                        <button class="px-2 py-0 border border-indigo-700 rounded-md "><i class="fa-solid fa-gear text-indigo-700"></i></button>
                        <button class="px-2 py-0 border bg-orange-400 border-orange-400 rounded-md "><i class="fa-regular fa-lightbulb text-white"></i></button>
                    </nav>
                </div>
                ...
                <div class="flex gap-x-4">
                    <div class="flex-1 ">
                        <div class="flex justify-between pl-10 mt-1">
                            <div class="kas flex items-center">
                                ...
                                <div class="flex justify-between items-center border border-gray-300 bg-white w-60 rounded-md">
                                    <div class="p-1">
                            ...
                            <div class="bukti flex items-center">
                                <div class=" flex items-center ">
                                    ...
                                    <button type="button" class="mx-2 group relative inline-flex h-5 w-10 flex-shrink-0 cursor-pointer items-center justify-center rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2" role="switch" aria-checked="false">
                        ...
                        <div class="flex justify-between pl-10 mt-1">
                            <div class="tanggal flex items-center">
                                ...
                                <div class="relative mt-2 flex items-center"><input type="text" name="search" id="search" class="block w-full rounded-md border-0 py-1.5 pr-8 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    <div class="absolute inset-y-0 right-0 flex py-1.5 pr-1.5"><i class="fa-solid fa-calendar-alt px-1 inline-flex items-center  text-gray-400"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="bukti flex items-center">
                            ...
                            <div class="flex-1 border border-gray-300 rounded-md rounded-tl-none">
                                <div class="px-4">
                                    <div class="flex items-center justify-between">
                                        <div class=" w-1/3">
                                            <div>
                                                <label for="search" class="hidden text-sm font-medium leading-6 text-gray-900">Quick
                                                    search</label>
                                                <div class="relative mt-2 flex items-center">
                                                    <input type="text" name="search" id="search" class="block w-full rounded-md border-0 py-1.5 pr-8 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                    <div class="absolute inset-y-0 right-0 flex py-1.5 pr-1.5">

                                                        <i class="fa-solid fa-search px-1 inline-flex items-center text-xs text-gray-400"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                                                <table class="min-w-full divide-y divide-gray-300">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col" class="py-3.5 pl-4 pr-3 w-6 text-left text-sm font-semibold text-gray-900 sm:pl-3">
                                                            </th>
                                                    ...
                                                    <tbody class="bg-white">
                                                        <tr class="even:bg-gray-50">
                                                            ...
                                                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-600 sm:pl-3">
                                                                112345</td>
                        ...
                        <div class="flex justify-end mt-4 ">
                            <div class="block border border-gray-300 rounded-md px-5 py-5 border-b-2 border-b-indigo-700">
                                <div> Nilai: </div>
                    ...
                    <nav class=" flex flex-col space-y-3 mt-1 mr-1 mb-1" aria-label="Tabs">
                        <button class="mb-5 px-3 py-3 border bg-blue-500 border-blue-500 rounded-md text-white">
                            <i class="fa-regular fa-floppy-disk text-2xl"></i> <i class="fa-solid fa-chevron-down pl-2 text-xs"></i></button>

                        <button class="px-3 py-3 border bg-blue-200 border-blue-500 rounded-md text-blue-500 ">
                            <i class="fa-solid fa-print text-2xl"></i> <i class="fa-solid fa-chevron-down pl-2 text-xs"></i></button>

                        <button class="px-3 py-3 border bg-blue-200 border-blue-500 rounded-md blue-500 text-blue-500 ">
                            <i class="fa-solid fa-paperclip text-2xl"></i> <i class="fa-solid fa-chevron-down pl-2 text-xs"></i></button>

                        <button class="px-3 py-3 border bg-green-300 border-green-500 rounded-md text-green-600">
                            <i class="fa-solid fa-briefcase text-2xl"></i> <i class="fa-solid fa-chevron-down pl-2 text-xs"></i></button>
